...
public class ShangjiaxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ShangjiaxinxiEntity shangjiaxinxi, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShangjiaxinxiEntity shangjiaxinxi, HttpServletRequest request){
        EntityWrapper<ShangjiaxinxiEntity> ew = new EntityWrapper<ShangjiaxinxiEntity>();
		PageUtils page = shangjiaxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shangjiaxinxi), params), params));
        return R.ok().put("data", page);
    }

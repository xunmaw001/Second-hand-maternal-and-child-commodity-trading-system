  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="适用性别" prop="shiyongxingbie">
          <el-select v-model="ruleForm.shiyongxingbie" placeholder="请选择适用性别">
            <el-option
                v-for="(item,index) in shiyongxingbieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="适用性别" prop="shiyongxingbie">
	      <el-input v-model="ruleForm.shiyongxingbie"
                placeholder="适用性别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="适用阶段" prop="shiyongjieduan">
          <el-input v-model="ruleForm.shiyongjieduan" 
              placeholder="适用阶段" clearable  :readonly="ro.shiyongjieduan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="适用阶段" prop="shiyongjieduan">
              <el-input v-model="ruleForm.shiyongjieduan" 
                placeholder="适用阶段" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="商品成色" prop="shangpinchengse">
          <el-select v-model="ruleForm.shangpinchengse" placeholder="请选择商品成色">
            <el-option
                v-for="(item,index) in shangpinchengseOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="商品成色" prop="shangpinchengse">
	      <el-input v-model="ruleForm.shangpinchengse"
                placeholder="商品成色" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="商品品牌" prop="shangpinpinpai">
              <el-input v-model="ruleForm.shangpinpinpai" 
                placeholder="商品品牌" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="商家编号" prop="shangjiabianhao">
          <el-select  @change="shangjiabianhaoChange" v-model="ruleForm.shangjiabianhao" placeholder="请选择商家编号">
            <el-option
                v-for="(item,index) in shangjiabianhaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.shangjiabianhao" label="商家编号" prop="shangjiabianhao">
...
export default {
  data() {
	...
	fenlei : false,
	tupian : false,
	shiyongxingbie : false,
	shiyongjieduan : false,
	...
	price : false,
            ...
            ruleForm: {
                	        shangpinmingcheng: '',
                                      ...
                                      fenleiOptions: [],
                                              shiyongxingbieOptions: [],
                                              shangpinchengseOptions: [],
                                                            shangjiabianhaoOptions: [],
                                                                                                        rules: {
                  shangpinmingcheng: [
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='shiyongxingbie'){
            this.ruleForm.shiyongxingbie = obj[o];
	    this.ro.shiyongxingbie = true;
            continue;
          }
	            	            if(o=='shiyongjieduan'){
            this.ruleForm.shiyongjieduan = obj[o];
	    this.ro.shiyongjieduan = true;
            continue;
          }
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                          ...
                                                          this.shiyongxingbieOptions = "通用,男,女".split(',')
                                                          this.shangpinchengseOptions = "全新,九成新,八成新,七成新及以下".split(',')
                                                                            this.$http({
              url: `option/shangjiaxinxi/shangjiabianhao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.shangjiabianhaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
                                                                            ...
                                                                            // 下二随
    shangjiabianhaoChange () {
      this.$http({
        url: `follow/shangjiaxinxi/shangjiabianhao?columnValue=`+ this.ruleForm.shangjiabianhao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
